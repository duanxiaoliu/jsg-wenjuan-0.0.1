				...
				<input type="hidden" name="id" id="id" value="${(employee.id)!""}"/>		
					...
					<div class="row-fluid">
						...
						<div class="col-xs-6">
							...
							<div class="col-xs-6">
								<select size="1" id="isJob" class="col-xs-9" name="isJob.id" aria-controls="dt_gal" onchange="changeCheck(this)">
									<option value="">请选择...</option>
									<#if employee.register ??>
										<#list YNDicList as dic>
											<#if dic.id == employee.register.id>
					...
					<div class="col-xs-12">
						<div class="row-fluid">
							<div class="col-xs-6">
								...
								<div class="col-xs-6">
									<input style="cursor:auto;background-color:#fff;" id="quitTime" class="Wdate col-xs-9" name="quitTime"  value="${(employee.quitTime)!""}" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'%y-%M-{%d}',isShowClear:true,readOnly:true})"/>
								</div>
							</div>
						</div>
					</div>
